...
def build_transform_gen(cfg, is_train):
    ...
    tfm_gens = []
    if is_train and not cfg.MODEL.WITH_LANGUAGE:
...
class DetrDatasetMapper:
    ...
    def __init__(self, cfg, is_train=True, test_categories=None):
        ...
        if self.lang_guide_det:
            ...
            if use_roberta:
                ...
                self.tokenizer = AutoTokenizer.from_pretrained('projects/CLARE/bert-base-uncased') # align with GLIP
    ...
    def __call__(self, dataset_dict):
        ...
        if "expressions" in dataset_dict:
            ...
            dataset_dict["expressions"] = expression
        ...
        if "annotations" in dataset_dict:
            ...
            if self.lang_guide_det and task == "detection":
                ...
                dataset_dict["expressions"] = anno["caption"] # "expressions" are shared between detection and grounding
