...
from detectron2.evaluation import COCOEvaluator, verify_results, DatasetEvaluators, LVISEvaluator, RetrievalEvaluator, RetrievalGroundingEvaluator
from detectron2.solver.build import maybe_add_gradient_clipping

from detectron2.projects.clare import build_detection_train_loader, build_detection_test_loader
from detectron2.projects.clare import add_clare_config
from detectron2.projects.clare.data import (
    get_detection_dataset_dicts, DetrDatasetMapperUni
)
import logging
...
# Unification
from detectron2.projects.clare.data import build_custom_train_loader
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type == "lvis":
            ...
            if "refcoco" in dataset_name or "rercoco" in dataset_name:
        ...
        if cfg.MODEL.RETRIEVAL and "rercoco" in dataset_name:
            evaluator_list = []
            evaluator_list.append(RetrievalGroundingEvaluator(cfg))
...
# python projects/CLARE/train_net.py --num-gpus 8 --config-file projects/CLARE/configs/rercoco_rer_siglip.yaml --resume
