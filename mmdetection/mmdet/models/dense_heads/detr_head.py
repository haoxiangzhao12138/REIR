...
class DETRHead(BaseModule):
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor,
        ...
        bbox_preds_list = [bbox_preds[i] for i in range(num_imgs)]# cxcywh
        ...
        bbox_targets = torch.cat(bbox_targets_list, 0)# cxcywh
        ...
        if isinstance(self.loss_cls, QualityFocalLoss):
            ...
            pos_bbox_targets = bbox_targets[pos_inds]# cxcywh
        ...
        bbox_preds = bbox_preds.reshape(-1, 4)# cxcywh
    ...
    def _get_targets_single(self, cls_score: Tensor, bbox_pred: Tensor,
        ...
        pred_instances = InstanceData(scores=cls_score, bboxes=bbox_pred) # xyxy
        ...
        # ref_gt_instances = img_meta['ref_gt_instances']
        # ref_gt_instances.bboxes = ref_gt_instances.bboxes.to(gt_instances.bboxes.device)
        # ref_gt_instances.labels = ref_gt_instances.labels.to(gt_instances.labels.device)
        # self.referring_assign_result = self.assigner.assign(
        #     pred_instances=pred_instances,
        #     gt_instances=ref_gt_instances,
        #     img_meta=img_meta
        # )

        gt_bboxes = gt_instances.bboxes# xyxy
        ...
        pos_gt_bboxes = gt_bboxes[pos_assigned_gt_inds.long(), :]# xyxy
        ...
        pos_gt_bboxes_normalized = pos_gt_bboxes / factor# xyxy
