...
model = dict(
    ...
    as_two_stage=True,
    # init_cfg=dict(type='Pretrained', checkpoint='/public/haoxiangzhao/REIR_upload/output/coco_pretrain_new/epoch_3.pth',),
    init_cfg=dict(type='Pretrained', checkpoint='/home/haoxiangzhao/REIR/output/coco_pretrain/epoch_5.pth',),
    dataset_name='coco',
