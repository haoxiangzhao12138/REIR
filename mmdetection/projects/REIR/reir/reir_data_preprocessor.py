...
class ReirDataPreprocessor(ImgDataPreprocessor):
    """Image pre-processor for reir tasks.
            ...
            if self.boxtype2tensor:
                ...
                for data_sample in data_samples:
                    if 'ref_gt_instances' in data_sample:
                        bboxes = data_sample.ref_gt_instances.get('bboxes', None)
                        if isinstance(bboxes, BaseBoxes):
                            data_sample.ref_gt_instances.bboxes = bboxes.tensor
