...
launcher = 'none'
load_from = '/public/haoxiangzhao/weights/deformable-detr-refine-twostage_r50_16xb2-50e_coco_20221021_184714-acc8a5ff.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/public/haoxiangzhao/datasets/coco/annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
