...
def parse_args():
    ...
    parser.add_argument("--src_json", default="datasets/annotations/refcocoplus-unc/instances.json", type=str, help="the original json file")
    parser.add_argument("--des_json", default="datasets/annotations/refcocoplus-unc/instances.json", type=str, help="the processed json file")
...
if __name__ == "__main__":
    ...
    for split in data.keys():
        ...
        for cur_data in tqdm(data[split]):
            inst_idx += 1
